            ...
            child: Column(
              children: [
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    enabledBorder: UnderlineInputBorder(
                      borderSide:
                          BorderSide(color: Color(0xFF0094ED), width: 15.0),
                    ...
                    errorBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: Colors.red,
                          width: 15.0), // Couleur de la bordure en cas d'erreur
                      borderRadius: BorderRadius.horizontal(
                        left: Radius.circular(12.0),
                        right: Radius.circular(12.0),
                      ),
                    ...
                    focusedErrorBorder: UnderlineInputBorder(
                      borderSide: BorderSide(
                          color: Colors.red,
                          width:
                              15.0), // Couleur de la bordure en cas d'erreur avec focus
                      borderRadius: BorderRadius.horizontal(
                        left: Radius.circular(12.0),
                        right: Radius.circular(12.0),
                      ),
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        // ignore: avoid_print
                        print("Nom: $nom, Prénom: $prenom, Nom d'utilisateur:username");
                      }
                    },
                ...
                Container(
                  ...
                  height: 50, // Hauteur fixe de 50 pixels
                  decoration: BoxDecoration(
                    color: Color.fromARGB(255, 248, 1, 1), // Couleur de fond bleue
                    borderRadius: BorderRadius.circular(
                        12), // Bordure arrondie avec un rayon de 12 pixels
                  ),
                  child: Row(
